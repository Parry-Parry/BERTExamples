...
def embed_queries(dataset : str, index_path : str, out_path : str, model : str = "bert-base-uncased", batch_size : int = 256, lookup="msmarco-passage/train/triples-small", cutoff : int = 10):
